...
#lot1
t.test(subset(Suspension_Coil_table, Manufacturing_Lot == "Lot1")$PSI, mu=mean(Suspension_Coil_table$PSI))
#lot2
t.test(subset(Suspension_Coil_table, Manufacturing_Lot == "Lot2")$PSI, mu=mean(Suspension_Coil_table$PSI))
#lot3
t.test(subset(Suspension_Coil_table, Manufacturing_Lot == "Lot3")$PSI, mu=mean(Suspension_Coil_table$PSI))
